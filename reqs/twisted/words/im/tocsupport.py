...
from reqs.twisted.internet import defer, reactor, protocol
from reqs.twisted.internet.defer import succeed

# Sibling Imports
from reqs.twisted.words.im import basesupport, interfaces, locals
