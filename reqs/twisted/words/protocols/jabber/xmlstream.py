...
from reqs.zope.interface import directlyProvides, implements

from reqs.twisted.internet import defer, protocol
from reqs.twisted.internet.error import ConnectionLost
from reqs.twisted.python import failure, log, randbytes
from reqs.twisted.python.hashlib import sha1
from reqs.twisted.words.protocols.jabber import error, ijabber, jid
from reqs.twisted.words.xish import domish, xmlstream
from reqs.twisted.words.xish.xmlstream import STREAM_CONNECTED_EVENT
from reqs.twisted.words.xish.xmlstream import STREAM_START_EVENT
from reqs.twisted.words.xish.xmlstream import STREAM_END_EVENT
from reqs.twisted.words.xish.xmlstream import STREAM_ERROR_EVENT
