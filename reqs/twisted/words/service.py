...
from reqs.twisted.words import iwords, ewords

from reqs.twisted.python.components import registerAdapter
from reqs.twisted.cred import portal, credentials, error as ecred
