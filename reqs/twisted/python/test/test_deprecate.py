...
from reqs.twisted.python import deprecate
from reqs.twisted.python.deprecate import _appendToDocstring
from reqs.twisted.python.deprecate import _getDeprecationDocstring
from reqs.twisted.python.deprecate import deprecated, getDeprecationWarningString
from reqs.twisted.python.deprecate import _getDeprecationWarningString
from reqs.twisted.python.deprecate import DEPRECATION_WARNING_FORMAT
from reqs.twisted.python.reflect import fullyQualifiedName
from reqs.twisted.python.versions import Version

from reqs.twisted.python.test import deprecatedattributes
