...
from reqs.twisted.trial.unittest import TestCase

from reqs.twisted.python.compat import set
from reqs.twisted.python.procutils import which
from reqs.twisted.python import release
from reqs.twisted.python.filepath import FilePath
from reqs.twisted.python.versions import Version
from reqs.twisted.python._release import _changeVersionInFile, getNextVersion
from reqs.twisted.python._release import findTwistedProjects, replaceInFile
from reqs.twisted.python._release import replaceProjectVersion
from reqs.twisted.python._release import updateTwistedVersionInformation, Project
from reqs.twisted.python._release import generateVersionFileData
from reqs.twisted.python._release import changeAllProjectVersions
from reqs.twisted.python._release import VERSION_OFFSET, DocBuilder, ManBuilder
from reqs.twisted.python._release import NoDocumentsFound, filePathDelta
from reqs.twisted.python._release import CommandFailed, BookBuilder
from reqs.twisted.python._release import DistributionBuilder, APIBuilder
from reqs.twisted.python._release import BuildAPIDocsScript
from reqs.twisted.python._release import buildAllTarballs, runCommand
from reqs.twisted.python._release import UncleanWorkingDirectory, NotWorkingDirectory
from reqs.twisted.python._release import ChangeVersionsScript, BuildTarballsScript
from reqs.twisted.python._release import NewsBuilder
...
try:
    from reqs.twisted.lore.scripts import lore
except ImportError:
