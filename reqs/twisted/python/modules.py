...
the modules outside the standard library's python-files directory::
    ...
    from reqs.twisted.python.modules import iterModules
...
from reqs.twisted.python.filepath import FilePath, UnlistableError
from reqs.twisted.python.zippath import ZipArchive
from reqs.twisted.python.reflect import namedAny
