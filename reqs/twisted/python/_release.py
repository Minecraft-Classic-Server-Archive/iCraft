...
from reqs.twisted.python.dist import twisted_subprojects
...
from reqs.twisted.python import versions
...
class DistributionBuilder(object):
    ...
    from reqs.twisted.python.dist import twisted_subprojects as subprojects
    blacklist = PROJECT_BLACKLIST
