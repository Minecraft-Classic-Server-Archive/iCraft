...
In order to use this support, simply do the following::
    ...
    |  from reqs.twisted.internet import gtk2reactor
    |  gtk2reactor.install()
...
# Twisted Imports
from reqs.twisted.python import log, runtime, failure
from reqs.twisted.python.compat import set
from reqs.twisted.internet.interfaces import IReactorFDSet
from reqs.twisted.internet import main, base, posixbase, error, selectreactor
...
class Gtk2Reactor(posixbase.PosixReactorBase):
    ...
    if runtime.platformType == 'posix':
        def _handleSignals(self):
            ...
            from reqs.twisted.internet.process import reapAllProcesses as _reapAllProcesses
