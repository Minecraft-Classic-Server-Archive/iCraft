...
from reqs.twisted.internet.defer import CancelledError
from reqs.twisted.internet.protocol import Protocol, ClientCreator
from reqs.twisted.internet.task import Clock
from reqs.twisted.trial.unittest import TestCase
from reqs.twisted.test.proto_helpers import MemoryReactor, StringTransport
