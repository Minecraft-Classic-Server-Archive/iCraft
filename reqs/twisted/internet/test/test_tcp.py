...
from reqs.twisted.internet.interfaces import IResolverSimple
from reqs.twisted.internet.address import IPv4Address
from reqs.twisted.internet.defer import succeed, fail
