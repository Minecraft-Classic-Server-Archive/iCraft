...
from reqs.twisted.internet.defer import Deferred
from reqs.twisted.internet.posixbase import PosixReactorBase, _Waker
...
from reqs.twisted.internet.tcp import Port
from reqs.twisted.internet import reactor
from reqs.twisted.test.test_unix import ClientProto
...
class PosixReactorBaseTests(TestCase):
    ...
    def test_IReactorArbitraryIsDeprecated(self):
        ...
        """
        from reqs.twisted.internet import interfaces
