...
from reqs.twisted.internet.protocol import ServerFactory, ClientFactory, Protocol
from reqs.twisted.internet.interfaces import ITLSTransport
from reqs.twisted.internet.defer import Deferred, DeferredList
from reqs.twisted.internet.error import ConnectionClosed
from reqs.twisted.trial.unittest import SkipTest
...
try:
    ...
    from reqs.twisted.internet.ssl import PrivateCertificate, KeyPair
    from reqs.twisted.internet.ssl import ClientContextFactory
