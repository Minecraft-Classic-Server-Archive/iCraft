from reqs.twisted.internet.protocol import ServerFactory, Protocol, ClientCreator
from reqs.twisted.internet.defer import DeferredList, maybeDeferred, Deferred
...
class IOCPReactorTestCase(unittest.TestCase):
    def test_noPendingTimerEvents(self):
        ...
        events.
        """
        from reqs.twisted.internet.iocpreactor.reactor import IOCPReactor
        ir = IOCPReactor()
        ir.wakeUp()
