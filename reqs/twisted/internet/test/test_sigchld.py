...
from reqs.twisted.python.log import msg
from reqs.twisted.trial.unittest import TestCase
from reqs.twisted.internet.fdesc import setNonBlocking
from reqs.twisted.internet._signals import installHandler, isDefaultHandler
from reqs.twisted.internet._signals import _extInstallHandler, _extIsDefaultHandler
from reqs.twisted.internet._signals import _installHandlerUsingSetWakeup, \
...
class ExtensionSIGCHLDTests(SIGCHLDTestsMixin, TestCase):
    ...
    """
    try:
        import reqs.twisted.internet._sigchld
    except ImportError:
