...
from reqs.twisted.python.util import switchUID
from reqs.twisted.internet import fdesc, abstract, error
from reqs.twisted.internet.main import CONNECTION_LOST, CONNECTION_DONE
