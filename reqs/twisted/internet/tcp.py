...
from reqs.twisted.python.runtime import platformType
...
if platformType == 'win32':
    ...
    from reqs.twisted.python.win32 import formatError as strerror
else:
...
# Twisted Imports
from reqs.twisted.internet import defer, base, address, fdesc
from reqs.twisted.internet.task import deferLater
...
from reqs.twisted.internet import abstract, main, interfaces, error
