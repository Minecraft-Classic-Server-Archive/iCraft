...
at some point)::
    ...
    from reqs.twisted.internet import inotify
    from reqs.twisted.python import filepath
...
from reqs.twisted.internet import fdesc
from reqs.twisted.internet.abstract import FileDescriptor
from reqs.twisted.python import log, _inotify
