...
from reqs.twisted.internet.interfaces import IHalfCloseableProtocol, ITransport, IAddress
from reqs.twisted.internet.interfaces import IConsumer, IPushProducer

from reqs.twisted.internet import _pollingfile, main
