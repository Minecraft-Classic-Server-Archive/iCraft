...
from reqs.zope.interface import implements, directlyProvides

from reqs.twisted.internet import interfaces, error, address, main, defer
from reqs.twisted.internet.abstract import isIPAddress
from reqs.twisted.internet.tcp import _SocketCloser, Connector as TCPConnector
from reqs.twisted.persisted import styles
from reqs.twisted.python import log, failure, reflect, util

from reqs.twisted.internet.iocpreactor import iocpsupport as _iocp, abstract
from reqs.twisted.internet.iocpreactor.interfaces import IReadWriteHandle
from reqs.twisted.internet.iocpreactor.const import ERROR_IO_PENDING
from reqs.twisted.internet.iocpreactor.const import SO_UPDATE_CONNECT_CONTEXT
from reqs.twisted.internet.iocpreactor.const import SO_UPDATE_ACCEPT_CONTEXT
from reqs.twisted.internet.iocpreactor.const import ERROR_CONNECTION_REFUSED
from reqs.twisted.internet.iocpreactor.const import ERROR_NETWORK_UNREACHABLE

try:
    from reqs.twisted.protocols.tls import TLSMemoryBIOFactory, TLSMemoryBIOProtocol
except ImportError:
