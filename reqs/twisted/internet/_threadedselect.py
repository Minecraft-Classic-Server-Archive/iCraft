...
the rest of Twisted::
    ...
    | from reqs.twisted.internet import _threadedselect
...
from reqs.twisted.internet.interfaces import IReactorFDSet
from reqs.twisted.internet import error
from reqs.twisted.internet import posixbase
from reqs.twisted.python import log, failure, threadable
...
from reqs.twisted.internet.selectreactor import _select
