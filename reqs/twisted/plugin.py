...
from reqs.zope.interface import Interface, providedBy
...
from reqs.twisted.python.components import getAdapterFactory
from reqs.twisted.python.reflect import namedAny
from reqs.twisted.python import log
from reqs.twisted.python.modules import getModule
...
def getPlugins(interface, package=None):
    ...
    """
    if package is None:
        import reqs.twisted.plugins as package
