...
try:
    from reqs.twisted.protocols.tls import TLSMemoryBIOProtocol, TLSMemoryBIOFactory
except ImportError:
    ...
    from reqs.twisted.internet.ssl import ClientContextFactory, PrivateCertificate
    from reqs.twisted.internet.ssl import DefaultOpenSSLContextFactory

from reqs.twisted.python.filepath import FilePath
from reqs.twisted.internet.interfaces import ISystemHandle, ISSLTransport
from reqs.twisted.internet.error import ConnectionDone
from reqs.twisted.internet.defer import Deferred, gatherResults
from reqs.twisted.internet.protocol import Protocol, ClientFactory, ServerFactory
from reqs.twisted.protocols.loopback import loopbackAsync, collapsingPumpPolicy
from reqs.twisted.trial.unittest import TestCase
from reqs.twisted.test.test_tcp import ConnectionLostNotifyingProtocol
from reqs.twisted.test.test_ssl import certPath
from reqs.twisted.test.proto_helpers import StringTransport
