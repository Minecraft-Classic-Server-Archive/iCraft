...
from reqs.zope.interface import implements, Interface

# twisted imports
from reqs.twisted.python import log, util
from reqs.twisted.python.deprecate import deprecated
from reqs.twisted.python.versions import Version
from reqs.twisted.python.hashlib import md5
from reqs.twisted.internet import protocol, defer, reactor

from twisted import cred
import reqs.twisted.cred.error
from reqs.twisted.cred.credentials import UsernameHashedPassword, UsernamePassword


# sibling imports
from reqs.twisted.protocols import basic
