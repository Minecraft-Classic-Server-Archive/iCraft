...
from reqs.zope.interface import Interface, implements

from reqs.twisted.python.compat import set
from reqs.twisted.python.util import unsignedID
from reqs.twisted.python.reflect import accumulateClassDict
from reqs.twisted.python.failure import Failure
from reqs.twisted.python import log, filepath

from reqs.twisted.internet.main import CONNECTION_LOST
from reqs.twisted.internet.error import PeerVerifyError, ConnectionLost
from reqs.twisted.internet.error import ConnectionClosed
from reqs.twisted.internet.defer import Deferred, maybeDeferred, fail
from reqs.twisted.protocols.basic import Int16StringReceiver, StatefulStringProtocol
...
if ssl is not None:
    from reqs.twisted.internet.ssl import CertificateOptions, Certificate, DN, KeyPair
