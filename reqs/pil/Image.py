...
try:
    ...
    # directly; from reqs.pil import Image and use the Image.core variable instead.
    import _imaging
    core = _imaging
    del _imaging
...
from reqs.pil import ImageMode
from reqs.pil import ImagePalette
...
class Image:
    ...
    def offset(self, xoffset, yoffset=None):
        ...
        from reqs.pil import ImageChops
...
def _showxv(image, title=None, **options):
    from reqs.pil import ImageShow
