...
from reqs.zope.interface.ro import ro
...
class SpecificationBasePy(object):
    ...
    def providedBy(self, ob):
        """Is the interface implemented by an object
          ...
          >>> from reqs.zope.interface import *
          >>> class I1(Interface):
          ...     pass
          >>> class C(object):
          ...     implements(I1)
    ...
    def isOrExtends(self, interface):
        ...
        Examples::
          ...
          >>> from reqs.zope.interface.declarations import Declaration
...
def _wire():
    from reqs.zope.interface.declarations import classImplements

    from reqs.zope.interface.interfaces import IAttribute
    classImplements(Attribute, IAttribute)

    from reqs.zope.interface.interfaces import IMethod
    classImplements(Method, IMethod)

    from reqs.zope.interface.interfaces import IInterface
    classImplements(InterfaceClass, IInterface)

    from reqs.zope.interface.interfaces import ISpecification
    classImplements(Specification, ISpecification)

# We import this here to deal with module dependencies.
from reqs.zope.interface.declarations import implementedBy
from reqs.zope.interface.declarations import providedBy
from reqs.zope.interface.exceptions import InvalidInterface
from reqs.zope.interface.exceptions import BrokenImplementation
