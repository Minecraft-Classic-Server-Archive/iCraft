...
from reqs.zope.interface.tests import odd
from reqs.zope.interface import Interface, implements, classProvides
from reqs.zope.interface import directlyProvides, providedBy, directlyProvidedBy
from reqs.zope.interface import classImplements, classImplementsOnly, implementedBy
