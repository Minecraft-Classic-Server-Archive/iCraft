...
from reqs.zope.interface import Interface, implements, classImplements, Attribute
from reqs.zope.interface.verify import verifyClass, verifyObject
from reqs.zope.interface.exceptions import DoesNotImplement, BrokenImplementation
from reqs.zope.interface.exceptions import BrokenMethodImplementation
...
class Test(unittest.TestCase):
    ...
    def testModule(self):
        ...
        from reqs.zope.interface.tests.ifoo import IFoo
        from reqs.zope.interface.tests import dummy
