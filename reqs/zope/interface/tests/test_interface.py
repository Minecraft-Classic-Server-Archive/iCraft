...
class InterfaceTests(unittest.TestCase):
    ...
    def _makeDerivedInterface(self):
        ...
        from reqs.zope.interface import Attribute
        class _I1(Interface):
    ...
    def testInterfaceExtendsInterface(self):
        from reqs.zope.interface.tests.unitfixtures import BazInterface
        from reqs.zope.interface.tests.unitfixtures import BarInterface
        from reqs.zope.interface.tests.unitfixtures import BobInterface
        from reqs.zope.interface.tests.unitfixtures import FunInterface
...
if sys.version_info >= (2, 4):
    ...
    def test_invariant_as_decorator():
        """Invaiants can be deined in line
          ...
          >>> from reqs.zope.interface import invariant
