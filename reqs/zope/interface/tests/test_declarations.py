...
from reqs.zope.interface import directlyProvides, providedBy
from reqs.zope.interface import classImplements, implementedBy, implementsOnly
...
def test_classProvides_before_implements():
    ...
    interfaces a bit quicker.
        ...
        For example::
          ...
          >>> from reqs.zope.interface import Interface, classProvides
...
def test_getting_spec_for_proxied_builtin_class():
    ...
    We'll create an implements specification:
      ...
      >>> import reqs.zope.interface.declarations
